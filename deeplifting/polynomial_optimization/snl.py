...
sensors, anchors, distmat = radiogen(n,radiorange) # generate the sensors' positions and the distance matrix
...
def snl_poly4(x, version = 'numpy'):
    ...
    if version == 'numpy':
        ...
        distvecx_ten = torch.sum(torch.abs(fullvecs_ten[:,I] - fullvecs_ten[:,J])**2,axis=0)
